...
class Stake extends Component {
  ...
  goto = (url = "https://app.uniswap.org/#/swap") => {
    console.log(url);
        ...
        <div className={classes.root} id="stakeRoot">
          ...
          <section className="stake-start-block">
            <ul className="stake-start-block__ul">
              <li className="stake-start-block__li">
                <p className="stake-start-block__title">
                  Total supply & borrow
                </p>
          ...
          <section className="stake-start-table">
            <div className="stake-start-table-top">
              ...
              {/* <form
              className={(classes.root, "stake-start-table__form")}
              noValidate
              autoComplete="off"
            >
              <div className="stake-start-table__search">
                <SearchIcon />
                <input
                  className="stake-start-table__input"
                  type="text"
                  placeholder="Search"
  ...
  renderOptions = () => {
    ...
    return (
      <div className={classes.actions + " ea_button_box"}>
        ...
        {["GovernanceV2"].includes(pool.id) && gov_voteLockValid && (
          <Typography variant={"h4"} className={classes.voteLockMessage}>
            You have recently voted, you can unstake at block {gov_voteLock}
          </Typography>
        )}
      </div>
    );
    ...
    return (
      <div className={classes.actions + " ea_button_box"}>
        <Typography className={classes.stakeTitle} variant={"h3"}>
          <span className="left">{t("Stake.StakeYourTokens")}</span>
  ...
  renderUnstake = () => {
    ...
    return (
      <div className={classes.actions + " ea_button_box"}>
        <Typography className={classes.stakeTitle} variant={"h3"}>
          <span className="left">{t("Stake.UnstakeYourTokens")}</span>
          <span className="right"></span>
        </Typography>
  ...
  renderAssetInput = (asset, type) => {
    ...
    return (
      <div
        className={classes.valContainer + " ea_val_container"}
        key={asset.id + "_" + type}
      >

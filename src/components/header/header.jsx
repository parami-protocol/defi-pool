...
import { Tabs, Tab, Typography, Card, Button } from "@material-ui/core";
...
function Header(props) {
  ...
  const rewardPool = rewardPools.filter(
    (items) => items.id === "GovernanceV2 defi"
  )[0];
  const rewardPoolUSDT = rewardPools.filter(
    (items) => items.id === "GovernanceV2USDT"
  )[0];
  const rewardPoolDAI = rewardPools.filter(
    (items) => items.id === "GovernanceV2Dai"
  )[0];
  const rewardPoolKANI = rewardPools.filter(
    (items) => items.id === "GovernanceV2Kani"
  )[0];
  const balancePoolKANI = rewardPools.filter(
    (items) => items.id === "BalanceKani"
  )[0];
          ...
          <div className="itemList">
            {/* {account.address && (
              <div className="pool-txt">
                <a
                  className={
                    type === 1 ? "pool-txt-btn-active" : "pool-txt-btn"
                  }
                  onClick={() => {
            ...
            {account.address && (
              <div className="pool-txt">
                <a
                  className={
                    type === 2 ? "pool-txt-btn-active" : "pool-txt-btn"
                  }
                  onClick={() => {
            ...
            {account.address && (
              <div className="pool-txt">
                <a
                  className={
                    type === 3 ? "pool-txt-btn-active" : "pool-txt-btn"
                  }
                  onClick={() => {
            ...
            {account.address && (
              <div className="pool-txt">
                <a
                  className={
                    type === 4 ? "pool-txt-btn-active" : "pool-txt-btn"
                  }
                  onClick={() => {
            ...
            <div className="pool-txt">
              <a
                ...
                href={"https://github.com/parami-protocol/defi-pool"}
                target="_blank"
            ...
            <div className="item">
              <FormControl>
                ...
                >
                  <MenuItem value={"en"} style={{ color: "#000" }}>
                    English
                  </MenuItem>
                  <MenuItem value={"cn"} style={{ color: "#000" }}>
                    中文
                  </MenuItem>
                  <MenuItem value={"ja"} style={{ color: "#000" }}>
                    日本語
                  </MenuItem>
                </Select>
              </FormControl>
